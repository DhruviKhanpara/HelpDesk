    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "System administrator with full access.", 1, true, "Admin" },
                    { 2L, "Support staff responsible for handling tickets.", 2, true, "Support Agent" },
                    { 3L, "Manager responsible for Views team tickets, reports, dashboards", 3, true, "Manager" },
                    { 4L, "Employee who can create and track support tickets.", 4, true, "Employee" }
                });
